...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOOT_USB_DFU_WAIT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOOT_USB_DFU_WAIT_DELAY_MS, 500);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MCUMGR_BUF_COUNT, 8);
