...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_NUS_THREAD_STACK_SIZE, 2048);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_SCAN_SHORT_NAME_MAX_LEN, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BMS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BMS_LOG_LEVEL_INF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BMS_LOG_LEVEL, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_TX_SIZE, 248);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_TX_COUNT, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BUF_ACL_RX_SIZE, 248);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DEVICE_NAME_MAX, 20);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DEVICE_NAME, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DEVICE_APPEARANCE, 1152);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SPI_3_NRF_RX_DELAY, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COUNTER_TIMER3, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CTLR_DATA_LENGTH_MAX, 240);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DFU_DETACH_TIMEOUT, 1000);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DFU_DEFAULT_POLLTIMEOUT, 256);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TASK_WDT_MIN_TIMEOUT, 1000);
